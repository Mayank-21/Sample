...
from maine_gov.ReusableFunctions import Scrape_BetweenString

class MaineGovPipeline(object):
    try:
        ...
        tableName = dbname + "." + "maine_gov_data"
        ...
        try:
            ...
            cur.execute('''CREATE TABLE '''+self.tableName+''' 
                                  ...
                                  InmateLink TEXT DEFAULT NULL,
                                    ...
                                    LinkStatus TEXT DEFAULT NULL,
                                    Location TEXT DEFAULT NULL,
                                    Alias TEXT DEFAULT NULL,
                                    Age TEXT DEFAULT NULL,
                                    Weight_Pounds TEXT DEFAULT NULL,
                                    Height TEXT DEFAULT NULL,
                                    Scars_Marks_Tattoos TEXT DEFAULT NULL,
                                    Convictions TEXT DEFAULT NULL,
                                    ConditionsofSupervision TEXT DEFAULT NULL,
                                    HTML_Save_Path_data TEXT DEFAULT NULL,
    ...
    def process_item(self, item, spider):
        try:
            ...
            #cur.execute("INSERT INTO maine_gov_data (InmateLink,first_name,last_name,inmate_number,race,gender,dob,incarceration_term,release_date,facility,active,hair_color,eye_color,image,state,last_updated,HTML_Save_Path_data) VALUES (" + "'" + str(item['InmateLink']) + "'" + ", " + "'" + str(item['first_name']) + "'" + ", " + "'" + str(item['last_name']) + "'" + "," + "'" + str(item['inmate_number']) + "'" + "," + "'" + str(item['race']) + "'" + "," + "'" + str(item['gender']) + "'" + "," + "'" + str(item['dob']) + "'" + "," + "'" + str(item['incarceration_term']) + "'" + "," + "'" + str(item['release_date']) + "'" + "," + "'" + str(item['facility']) + "'" + "," + "'" + str(item['active']) + "'" + "," + "'" + str(item['hair_color']) + "'" + "," + "'" + str(item['eye_color']) + "'" + "," + "'" + str(item['image']) + "'" + "," + "'" + str(item['state']) + "'" + "," + "'" + str(item['last_updated']) + "'" + "," + "'" + item['HTML_Save_Path_data'] + "'" + ")");
            cur.execute("INSERT INTO " + self.tableName + " (InmateLink,first_name,last_name,inmate_number,race,gender,dob,incarceration_term,release_date,facility,active,hair_color,eye_color,image,state,last_updated,LinkStatus,Location,Alias,Age,Weight_Pounds,Height,Scars_Marks_Tattoos,Convictions,ConditionsofSupervision,HTML_Save_Path_data) VALUES (" + "'" + str(item['InmateLink']) + "'" + ", " + "'" + str(item['first_name']) + "'" + ", " + "'" + str(item['last_name']) + "'" + "," + "'" + str(item['inmate_number']) + "'" + "," + "'" + str(item['race']) + "'" + "," + "'" + str(item['gender']) + "'" + "," + "'" + str(item['dob']) + "'" + "," + "'" + str(item['incarceration_term']) + "'" + "," + "'" + str(item['release_date']) + "'" + "," + "'" + str(item['facility']) + "'" + "," + "'" + str(item['active']) + "'" + "," + "'" + str(item['hair_color']) + "'" + "," + "'" + str(item['eye_color']) + "'" + "," + "'" + str(item['image']) + "'" + "," + "'" + str(item['state']) + "'" + "," + "'" + str(item['last_updated']) + "'" + "," + "'" + str(item['LinkStatus']) + "'" + "," + "'" + str(item['Location']) + "'" + "," + "'" + str(item['Alias']) + "'" + "," + "'" + str(item['Age']) + "'" + "," + "'" + str(item['Weight_Pounds']) + "'" + "," + "'" + str(item['Height']) + "'" + "," + "'" + str(item['Scars_Marks_Tattoos']) + "'" + "," + "'" + str(item['Convictions']) + "'" + "," + "'" + str(item['ConditionsofSupervision']) + "'" + "," + "'" + item['HTML_Save_Path_data'] + "'" + ")");
